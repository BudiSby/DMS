    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="form-actions no-color">
                        <p>
                            ...
                            <select name="findby" id="findby">
                                <option value="year_name" <?= $year_name_selected; ?>>Year</option>
                ...
                <a href="<?= base_url($link . '/new'); ?>" class="btn btn-primary btn-sm mb-2">New Year</a>
                <div class="card">
                            ...
                            <tbody>
                                ...
                                foreach ($data as $d) : ?>
                                    <tr>
                                        ...
                                        <td><?= $d['updated_at']; ?></td>
                                        <td>
                                            <a class="btn btn-warning btn-sm mb-2" href="<?= base_url($link . '/' . $d['noyear'] . '/edit'); ?>">Edit / Detail</a>
                                            <form class="d-inline" action='<?= base_url($link . '/' . $d['noyear']); ?>' method='post' enctype='multipart/form-data'>
                                                <?= csrf_field(); ?>
