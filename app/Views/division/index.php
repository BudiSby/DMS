    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <a href="<?= base_url($link . '/new'); ?>" class="btn btn-primary btn-sm mb-2">New Division</a>
                <div class="card">
                            ...
                            <tbody>
                                ...
                                foreach ($data as $d) : ?>
                                    <tr>
                                        ...
                                        <td><?= $d['updated_at']; ?></td>
                                        <td>
                                            <a class="btn btn-warning btn-sm mb-2" href="<?= base_url($link . '/' . $d['nodiv'] . '/edit'); ?>">Edit / Detail</a>
                                            <form class="d-inline" action='<?= base_url($link . '/' . $d['nodiv']); ?>' method='post' enctype='multipart/form-data'>
                                                <?= csrf_field(); ?>
