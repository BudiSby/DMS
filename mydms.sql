...
INSERT INTO `doc` (`nodoc`, `noyear`, `nodiv`, `nosubdiv`, `nodoctype`, `doc_name`, `description`, `xdoc1_name`, `xdoc1`, `cid`, `uid`, `did`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 2, 3, 2, 2, 'test doc1', 'testing document 1', 'PILSHIP IDUPG - not on list.png.png', '001a83fa46c8f754f6ef9958464d05000baa9f33.png', 0, 1, 0, '2023-12-14 03:44:07', '2024-01-03 12:02:05', '2023-12-14 03:44:07'),
(2, 1, 2, 1, 3, 'test doc2', 'testing document 2', 'Eid Mubarak - PIL.png.png', '44290633a9ed47c611435f8cfd52288053bb5cc3.png', 1, 1, 0, '2023-12-14 03:44:07', '2024-01-03 09:10:05', '2023-12-14 03:44:07'),
(8, 1, 4, 2, 1, 'pil test doc 3', 'testing document xyz', 'PILSHIP IDSRI - Map not show.png.png', '5e224d1e9b8b0ecd57aee7020c06974e641d6ff3.png', 1, 1, 0, '2023-12-19 16:32:41', '2024-01-03 16:01:43', '0000-00-00 00:00:00'),
(9, 1, 1, 1, 1, 'pil test doc 4', 'testing document xyz', '', '', 1, 0, 0, '2023-12-20 11:11:58', '2023-12-20 11:11:58', '0000-00-00 00:00:00'),
(10, 1, 5, 1, 1, 'pil test doc 5', 'testing document ', '', '', 1, 1, 0, '2023-12-20 11:12:15', '2023-12-29 10:21:44', '0000-00-00 00:00:00'),
(11, 1, 1, 1, 1, 'pil test doc 6', 'testing document 6', '', '', 1, 1, 0, '2023-12-20 13:33:09', '2023-12-20 13:38:33', '0000-00-00 00:00:00'),
(12, 1, 6, 1, 1, 'doc. div doc', 'doc. div doc', '', '', 1, 0, 0, '2023-12-29 10:25:00', '2023-12-29 10:25:00', '0000-00-00 00:00:00'),
(13, 1, 2, 1, 2, 'doc. div doc', 'AGT Requisition for Jul 2023  IDSUB1  Liner', 'PIL81_IN.TXT.txt', '9a121cb2f49e467c9defd952fdd56539d34d1c6d.txt', 1, 0, 0, '2024-01-02 14:22:34', '2024-01-02 14:22:34', '0000-00-00 00:00:00');
...
(2, 'Member', 'member', 'member@gmail.com', '$2y$10$j1DUadXW3FpeYAtRab7YXOmxdQSETLN7Pvza/ay3P9CX0TFi4KBzm', 'user.png', 2, '2023-12-13 14:27:50', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'Robby Budiawan', 'Budiawan', 'robby.budiawan@sub.pilship.com', '$2y$10$.ymcTvYcovk189dHaceKb.jE6qCSEPznB67Oci4SaKbrmgZbYs3wi', 'c80eb094a38ac9b3d8165e03ce74d23ba02bb776.png', 2, '2023-12-13 14:41:06', 1, NULL, 1, NULL, '2023-12-13 14:41:06', '2023-12-28 10:44:03', NULL);
...
(1, '2024', 'Year of 2024', 1, 0, 0, '2024-01-03 11:49:30', '2024-01-03 11:49:30', '0000-00-00 00:00:00'),
(2, '2023', 'Year of 2023', 1, 0, 0, '2024-01-03 11:49:46', '2024-01-03 11:49:46', '0000-00-00 00:00:00'),
(4, '2022', 'Year of 2022', 1, 0, 0, '2024-01-03 11:50:52', '2024-01-03 11:50:52', '0000-00-00 00:00:00');
...
--
ALTER TABLE `division`
  MODIFY `nodiv` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `doc`
--
ALTER TABLE `doc`
  MODIFY `nodoc` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `years`
  MODIFY `noyear` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
